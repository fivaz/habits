...
type AnchorMissingViewProps = {
	habit: TodayHabitUI;
	onResetFlow: () => void;
	updateHabit: (habit: TodayHabitUI) => void;
};

export function AnchorMissingView({ updateHabit, habit, onResetFlow }: AnchorMissingViewProps) {
	...
	return (
		<>
			<RedesignSuggestions reasonId="anchor_missing" />
